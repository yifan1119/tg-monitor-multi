...
const TEMPLATES = {
  ...
  review: {
    ...
    columns: [
      { header: "编号",           field: "reviewNo",         width: 130, wrap: false },
      { header: "外部广告对接群", field: "externalGroup",    width: 150, wrap: false },
      { header: "产品所属公司",   field: "company",          width: 120, wrap: false },
      { header: "广告类型",       field: "adType",           width: 85,  wrap: false },
      { header: "广告主",         field: "advertiser",       width: 95,  wrap: false },
      { header: "对接商务",       field: "businessOwner",    width: 95,  wrap: false },
      { header: "对应外事号",     field: "externalOperator", width: 105, wrap: false },
      { header: "问题情况说明",   field: "issueDesc",        width: 260, wrap: true  },
      { header: "初步认定",       field: "initialFinding",   width: 260, wrap: true  },
      { header: "登记时间",       field: "createdAt",        width: 150, wrap: false },
      { header: "审查人",         field: "reviewer",         width: 85,  wrap: false },
      { header: "",               field: "_empty",           width: 40,  wrap: false },
      { header: "闭环详情",       field: "closureDetail",    width: 260, wrap: true  },
    ],
